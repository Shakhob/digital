                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php echo $form->field($model->translate('uz'), "[uz]url")->textInput()->label("[uz]url");?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php echo $form->field($model->translate('ru'), "[ru]url")->textInput()->label("[ru]url");?>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php echo $form->field($model->translate('en'), "[en]url")->textInput()->label("[en]url");?>
                            </div>
                        </div>
                    </div>
                </div>
